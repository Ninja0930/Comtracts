        ...
        <div className="w-full h-screen overflow-y-hidden dark:bg-[rgb(18,18,18)]">
            ...
            <div className=''>
                ...
                <div className=' absolute z-10 mt-[-70px] lg:mt-[-160px] sm:mt-[-110px] ml-[40px] lg:ml-[70px]'>
                    <div className='justify-center flex group items-center h-[6rem] w-[6rem] overflow-y-hidden bg-[#e1e1e1] hover:bg-[#cbcbcb] transition-all dark:bg-[rgb(30,30,30)] dark:hover:bg-[rgb(33,33,33)] cursor-pointer lg:h-[12rem] lg:w-[12rem] sm:h-[9rem] sm:w-[9rem] dark:border-[rgb(18,18,18)] border-[#ffffff] border-[5px] rounded-[50%]'>
                        {avatarFile ?
                            <span className='w-full h-full flex bg-contain bg-no-repeat bg-center overflow-y-hidden'>
                ...
                <div className=' flex flex-wrap'>
                    ...
                    <div className=' flex justify-end items-end  px-[40px] sm:px-[60px] lg:px-[90px] mt-[30px]'>
                        ...
                        <a onClick={editProfilePageOpen} style={{ fontFamily: 'Might',width:'100%', fontSize: '18px', transition: '0.1s' }} className="relative rounded-[0.5rem] cursor-pointer group font-medium no-underline flex p-2 text-white items-center justify-center content-center focus:outline-none">
                            <span className="absolute top-0 left-0 w-full h-full rounded opacity-50 filter blur-sm bg-gradient-to-br from-[#256fc4] to-[#256fc4]"  ></span>
