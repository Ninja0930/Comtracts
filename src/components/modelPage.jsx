    ...
    return (
        <div className="w-full h-screen overflow-y-hidden dark:bg-[rgb(22,22,22)]">
            ...
            <div className=' w-[100%] dark:bg-[rgb(22,22,22)] fixed top-[100px] flex justify-center items-center'>
                <div class=" m-h-screen xl:w-[30%] sm:w-[50%]">
                    <div class=" dark:bg-[rgb(36,37,38)] items-center justify-between w-full flex rounded-full shadow-lg p-2 mb-3 sticky" style={{ marginTop: '5px' }}>
                        <div>
                            <div class="p-2 mr-1 rounded-full hover:bg-white dark:hover:bg-[rgb(75,85,99)] cursor-pointer">
                                ...
                                <svg class="h-5 w-5 text-gray-500 dark:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <input value={value} onChange={({ target: { value } }) => { setValue(value) }} class="font-bold rounded-full w-full py-[0.65rem] pl-4 text-gray-700 dark:text-white bg-gray-100 dark:bg-[rgb(50,50,50)] leading-tight focus:outline-none focus:shadow-outline lg:text-sm text-xs" type="text" placeholder="Search" />
            ...
            <div className="w-[100%] h-full dark:bg-[rgb(22,22,22)] z-[2] flex  flex-col items-center justify-center mt-[200px]">
                ...
                <div className='w-[90%] sm:w-[70%] dark:bg-[rgb(22,22,22)] overflow-y-scroll flex gap-x-5 gap-y-7 flex-wrap items-center justify-center mb-[200px] pb-[50px]'>
                    {
